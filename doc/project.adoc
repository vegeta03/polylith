...
To support IDEs and other tooling, you must compensate by adding your brick tests as separate paths in your `./deps.edn`, just as you did for your xref:component.adoc#add-to-deps-edn-component[user component] and xref:base.adoc#add-to-deps-edn-base[cli base].
====
