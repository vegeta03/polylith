...
(deftest ifc-deps-table
  (is (= ["                                                                                            w"
          ...
          "                    l  a  m  m  a  d  f     h     a  n     h     l  n  a  n  n  u  a  s  p  -  o  f"
          "                 a  e  n  a  m  t  e  i  g  e  l  t  d     e  t  p  n  b  f  p  t  t  i  a  c  r  i"
          "                 p  t  g  n  o  o  p  l  i  l  i  o  e  s  l  a  e  e  l  i  u  i  o  o  c  l  e  l"
          "  brick          i  e  e  d  n  r  s  e  t  p  b  r  r  h  l  p  r  r  e  g  t  l  r  n  e  j  r  e"
          "  -------------------------------------------------------------------------------------------------"
          "  api            .  .  x  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  x  .  .  .  x  x  x  ."
          "  autocomplete   .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  ."
          "  change         .  .  .  .  .  .  .  .  x  .  .  .  x  .  .  .  .  .  .  .  .  x  .  .  .  .  .  ."
...
(deftest project-deps-table
  (let [ws (workspace)
    ...
    (is (= ["                                                                                         w"
            ...
            "                 p  h  m  o  e                 r  i     s     e  u  t  o  i     d  r  s  e  l  -"
            "                 l  a  m  m  a  d  f     h     a  n     h     l  n  a  n  n  u  a  s  p  -  o  f"
            "                 e  n  a  m  t  e  i  g  e  l  t  d     e  t  p  n  b  f  p  t  t  i  a  c  r  i"
            "                 t  g  n  o  o  p  l  i  l  i  o  e  s  l  a  e  e  l  i  u  i  o  o  c  l  e  l"
            "  brick          e  e  d  n  r  s  e  t  p  b  r  r  h  l  p  r  r  e  g  t  l  r  n  e  j  r  e"
            "  ----------------------------------------------------------------------------------------------"
            "  autocomplete   .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  ."
            "  change         .  .  .  .  .  .  +  x  .  .  .  x  +  .  .  .  .  .  .  .  x  .  .  .  .  .  ."
            "  command        x  x  .  x  x  x  x  x  x  x  x  +  +  x  x  .  x  +  x  +  x  x  x  x  x  x  x"
  ...
  (is (= {"autocomplete"  {:src  {}
          ...
          "change"        {:src  {:direct   ["git"
                           ...
                           :test {:direct   ["git"
                                  ...
                                  :indirect ["file"
                                             "sh"]}}
          "command"       {:src  {:direct   ["autocomplete"
                                             "change"
                                             "common"
                                             "creator"
                                             "deps"
